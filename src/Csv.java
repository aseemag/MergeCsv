...
public class Csv {
  public static void main(String args[])
  {
	  try {
		...
		read.readHeaders();
		System.out.println("Csv.main()"+read.getHeader(1));
		while (read.readRecord())
		{
			String productID = read.get("email");
		...
		File f=new File("/home/aseema/work/test1.csv");
	   ...
	   long startTime=System.currentTimeMillis();
		...
		System.out.println("Csv.main()Total time taken="+(endtime-startTime));
